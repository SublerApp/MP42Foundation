...
NSString *const MP42AudioFormatMP1 = @"MP1";
NSString *const MP42AudioFormatMP2 = @"MP2";
...
// Subtitle Format
NSString *const MP42SubtitleFormatWebVTT = @"WebVTT";
